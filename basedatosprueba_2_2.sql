...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2024 a las 05:02:21
...
--
-- Estructura de tabla para la tabla `historial_registros_paciente`
--

CREATE TABLE `historial_registros_paciente` (
  `id` int NOT NULL,
...
--
-- Volcado de datos para la tabla `historial_registros_paciente`
--

INSERT INTO `historial_registros_paciente` (`id`, `id_registro`, `record_date`, `record_time`, `presion_sistolica`, `presion_diastolica`, `presion_media`, `pulso`, `temperatura`, `frecuencia_respiratoria`, `saturacion_oxigeno`, `peso_adulto`, `peso_pediatrico`, `talla`, `observaciones`, `responsable_signos`, `created_at`) VALUES
(1, 34, '2021-08-02', '17:55:00', 120, 80, 93, 50, 35, 50, 100, NULL, 20, 120, NULL, 'Laura Quintero', '2024-11-29 22:42:34'),
(2, 46, '2024-11-21', '17:31:00', 120, 80, 83, 52, 35, 52, 100, 20, NULL, 120, '', 'Laura Quintero', '2024-11-30 03:25:25'),
(3, 47, '2024-11-21', '17:40:00', 120, 80, 83, 50, 35, 50, 100, NULL, 20, 20, '', 'Laura Quintero', '2024-11-30 03:40:14'),
(4, 53, '2024-11-22', '10:25:00', 120, 80, 83, 40, 35, 50, 100, NULL, 20, 120, '', 'Laura Quintero', '2024-11-30 03:41:03'),
(5, 34, '1902-02-22', '14:22:00', 120, 80, 93, 50, 50, 50, 100, NULL, 120, 20, NULL, 'Laura Quintero', '2024-11-30 03:42:53'),
(6, 34, '2003-03-02', '17:55:00', 120, 80, 93, 50, 35, 50, 85, NULL, 20, 120, 'dqas', 'Laura Quintero', '2024-11-30 03:44:18'),
(7, 34, '2024-02-22', '17:06:00', 12, 12, 12, 12, 12, 12, 12, NULL, 120, 21, 'dqas', 'Laura Quintero', '2024-11-30 03:46:05'),
(8, 34, '2024-02-20', '18:06:00', 12, 12, 12, 12, 12, 12, 12, NULL, 12, 12, 'dqas', 'Laura Quintero', '2024-11-30 03:46:49');
...
(20, 'Andrés', 'Martín', 'Serrano', 'Gómez', '369741258', 'cédula de ciudadanía', '110C', 'activo', '2024-01-21 10:00:00', '1997-07-03', 'Adulto', 'Aura Lara'),
...
(54, 'Ana', '', 'Sánchez', 'González', '963852749', 'cédula de ciudadanía', '150A', 'activo', '2024-02-24 10:00:00', '2024-07-10', 'Lactante temprano', 'Laura Quintero'),
...
(1079060, 'Alejandro', 'David', 'Lara', 'Resto', '1003383318', 'cédula de ciudadanía', '17B', 'activo', '2024-11-26 02:44:13', '2004-09-13', 'Adulto', 'Laura Quintero'),
...
(53, 54, '2024-05-22', '17:52:00', 120, 80, 93.00, 50, 35.0, 50, 50, NULL, 35.0, 120, '', '2024-11-22 15:26:15', 'Laura Quintero'),
...
--
-- Indices de la tabla `historial_registros_paciente`
--
ALTER TABLE `historial_registros_paciente`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `historial_registros_paciente`
--
ALTER TABLE `historial_registros_paciente`
...
--
ALTER TABLE `patients`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1079063;
...
--
-- Filtros para la tabla `historial_registros_paciente`
--
ALTER TABLE `historial_registros_paciente`
  ADD CONSTRAINT `historial_registros_paciente_ibfk_1` FOREIGN KEY (`id_registro`) REFERENCES `registros_paciente` (`id`);
